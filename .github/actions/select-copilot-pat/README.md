...
Based on the pattern established in
[dotnet/runtime#126057](https://github.com/dotnet/runtime/pull/126057).
  ...
  my-ai-job:
    ...
    steps:
      - name: Call Copilot API
        env:
          COPILOT_TOKEN: ${{ needs.select-pat.outputs.copilot_pat_number == '0' && secrets.COPILOT_PAT_0
            || needs.select-pat.outputs.copilot_pat_number == '1' && secrets.COPILOT_PAT_1
            || '' }}
        run: |
